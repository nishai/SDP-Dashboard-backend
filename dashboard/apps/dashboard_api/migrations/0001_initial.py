# Generated by Django 2.1 on 2018-09-17 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encrypted_student_no', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='dashboard_api.StudentInfo')),
                ('program_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='dashboard_api.ProgramInfo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard_api.ProgressDiscription'),
        ),
