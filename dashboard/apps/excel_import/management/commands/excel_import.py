            ...
            for _model in api_models:
                ...
                for row in data:
                    ...
                    for key in _model_dict:
                        if key in foreign_key_fields_dict:
                            try:
                                ...
                                logger.warning("foreign key not found for key: " + str(key) + " with value: " + str(
                                    _model_dict[key]))
                    ...
                    if _model.__name__ == "StudentPrograms":
                        if row[titles.index("year_of_study")] == "YOS 3" and row[
                            titles.index("progress_outcome_type")] == "Q":
                    ...
                    if _model.__name__ == "CourseStats":
                        ...
                        if stats_row is not None:
                            if _model_dict["final_mark"] is None:
                                _model_dict["final_mark"] = stats_row["final_mark"]
                            elif stats_row["final_mark"] is None:
